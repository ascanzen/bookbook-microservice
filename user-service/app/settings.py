...
class Settings(BaseSettings):
    ...
    https_on: bool = False
    api_secret: str = secrets.token_urlsafe(64)

    database_url = (
        "mysql+pymysql://iotServer:8o2hm6hNQx4LZBKJ@172.21.0.10:3306/iot_server_new"
    )
    database_url_sync = (
        "mysql+pymysql://iotServer:8o2hm6hNQx4LZBKJ@172.21.0.10:3306/iot_server_new"
    )
    api_root_path = "/gs/mqtt"

    mysql_host = "172.21.0.10"
    mysql_port = 3306
